...
def main(decade_to_process):
    ...
    save_dir = '/storage/ggarcia_g/imandt/updated_decade_mutual_info'
    ...
    np.save(os.path.join(save_dir, f'updated_mutual_info_matrix_decade_{int(decade)}.npy'), mutual_info_matrix_decade)
